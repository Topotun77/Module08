...
# Также в numbers может быть записана не коллекция, а другие типы данных, например
# числа. Обработайте исключение TypeError выводя строку ('В numbers записан некорректный
# тип данных'). В таком случае функция просто вернёт None.
